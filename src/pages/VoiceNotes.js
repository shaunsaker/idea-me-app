...
export class VoiceNotes extends React.Component {
    ...
    componentDidMount() {
        ...
        if (this.props.idea.voiceNotes || this.props.newVoiceNotes) {
            const newVoiceNotes = this.props.idea.voiceNotes
    ...
    addNewVoiceNote(newVoiceNoteFilePath) {
        Permissions.handlePermission(
            ...
            () => {
                ...
                const newVoiceNotes = utilities.pushObjectToDictionary(
                    newVoiceNote,
                    this.props.newVoiceNotes
                );
    ...
    deleteVoiceNote() {
        ...
        const newVoiceNotes = utilities.removeObjectFromDictionary(
            this.state.deleteVoiceNoteUID,
            this.props.newVoiceNotes
        );
    ...
    render() {
        const voiceNotesArray = utilities.convertDictionaryToArray(
            this.props.newVoiceNotes
        );
        ...
        return (
            <Page backgroundColor={styleConstants.white} removeBottomPadding>
                <Header headerShadow backButton text="Voice Notes" />
